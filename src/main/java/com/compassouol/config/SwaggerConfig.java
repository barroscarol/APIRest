...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.compassouol.resources")).paths(PathSelectors.any())
				.build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API Spring Boot ||  CompassoUOL ", "Api Desenvolvida para operações CRUD no padrão REST",
				"Versão 1.0", " ",
				new Contact("Maria Carolina Barros", "https://github.com/barroscarol", "carolbarrosnasc@gmail.com"),
